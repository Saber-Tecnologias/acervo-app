...
public class DialogFragmentMoverItem extends DialogFragment implements OnClickListener{
	...
	public void init(Context ctx, OnClickListener clickListener, Item i, ArrayList<Grupo> grupos) {
		if(d == null){
			mContext = ctx;
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		if(savedInstanceState  == null){
			...
			View v = inflater.inflate(R.layout.dialog_moveritem, null);
